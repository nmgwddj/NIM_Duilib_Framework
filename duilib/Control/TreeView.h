...
public:
     ...
     * @return 无
     */
    void AttachExpand(const EventCallback& callback) {
        OnEvent[kEventExpand] += callback;
    }
     ...
     * @return 无
     */
    void AttachUnExpand(const EventCallback& callback) {
        OnEvent[kEventUnExpand] += callback;
    }
