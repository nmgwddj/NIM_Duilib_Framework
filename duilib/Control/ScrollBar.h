...
public:
    ...
    /**
     * @brief 设置滚动条方向
     * @param[in] 设置 true 代表是水平滚动条，设置 false
     * 代表是垂直滚动条，默认为 true
     * @return 无
     */
     ...
     * @return 无
     */
    void SetButton1StateImage(ControlStateType stateType,
     ...
     * @return 无
     */
    void SetButton2StateImage(ControlStateType stateType,
                              const std::wstring& pStrImage);
     ...
     * @return 无
     */
    void SetThumbStateImage(ControlStateType stateType,
                            const std::wstring& pStrImage);
     ...
     * @return 无
     */
    void SetRailStateImage(ControlStateType stateType,
                           const std::wstring& pStrImage);
     ...
     * @return 无
     */
    void SetBkStateImage(ControlStateType stateType,
                         const std::wstring& pStrImage);
