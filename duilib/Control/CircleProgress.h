...
public:
     ...
     * @param[in] bCircular 为 true 时设置为环型进度条，false
     * 时设置为父级进度条样式，默认为 true
     * @return 无
     */
    ...
    /**
     * @brief 设置递增方向
     * @param[in] bClockwise 为 true 时设置为顺时针，false
     * 时设置为逆时针，默认为 true
     * @return 无
     */
    ...
    /**
     * @brief 设置进度条背景颜色
     * @param[in] strColor要设置的背景颜色字符串，该字符串必须在 global.xml
     * 中存在
     * @return 无
     */
    ...
    /**
     * @brief 设置进度条前景颜色
     * @param[in] strColor要设置的前景颜色字符串，该字符串必须在 global.xml
     * 中存在
     * @return 无
     */
    ...
    /**
     * @brief 设置进度条前景渐变颜色，与 SetForegroudColor
     * 同时使用，可以不设置,则无渐变效果
     * @param[in] strColor要设置的前景渐变颜色字符串，该字符串必须在 global.xml
     * 中存在
     * @return 无
     */
