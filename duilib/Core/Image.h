...
public:
    ...
    static std::unique_ptr<ImageInfo> LoadImage(
...
private:
    static std::unique_ptr<ImageInfo> LoadImageByBitmap(
...
public:
    ...
    static void ModifyAttribute(ImageAttribute& imageAttribute,
...
public:
    ...
    bool HasHotImage();
    bool HasImage();
    bool PaintStatusImage(IRenderContext* pRender,
...
public:
    ...
    void SetImage(StateImageType stateImageType,
                  ControlStateType stateType,
                  const std::wstring& strImagePath);
    std::wstring GetImagePath(StateImageType stateImageType,
                              ControlStateType stateType);
...
public:
    ...
    bool HasHotColor();
    bool HasColor();
    void PaintStatusColor(IRenderContext* pRender,
                          UiRect rcPaint,
                          ControlStateType stateType);
