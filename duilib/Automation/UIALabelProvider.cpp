...
//
IFACEMETHODIMP UIALabelProvider::QueryInterface(REFIID riid,
                                                void** ppInterface) {
    *ppInterface = nullptr;
...
//
IFACEMETHODIMP UIALabelProvider::GetPatternProvider(PATTERNID patternId,
                                                    IUnknown** pRetVal) {
...
//
IFACEMETHODIMP UIALabelProvider::GetPropertyValue(PROPERTYID propertyId,
                                                  VARIANT* pRetVal) {
    pRetVal->vt = VT_EMPTY;
    UIA_CHECK_ELEMENT(m_pControl);
