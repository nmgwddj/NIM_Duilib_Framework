...
//
IFACEMETHODIMP UIAButtonProvider::QueryInterface(REFIID riid,
                                                 void** ppInterface) {
    *ppInterface = nullptr;
...
//
IFACEMETHODIMP UIAButtonProvider::GetPatternProvider(PATTERNID patternId,
                                                     IUnknown** pRetVal) {
...
IFACEMETHODIMP UIAButtonProvider::GetPropertyValue(PROPERTYID propertyId,
                                                   VARIANT* pRetVal) {
    pRetVal->vt = VT_EMPTY;
    UIA_CHECK_ELEMENT(m_pControl);
