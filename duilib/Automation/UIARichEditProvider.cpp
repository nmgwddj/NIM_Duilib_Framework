...
//
IFACEMETHODIMP UIARichEditProvider::QueryInterface(REFIID riid,
                                                   void** ppInterface) {
    *ppInterface = nullptr;
...
//
IFACEMETHODIMP UIARichEditProvider::GetPatternProvider(PATTERNID patternId,
                                                       IUnknown** pRetVal) {
...
//
IFACEMETHODIMP UIARichEditProvider::GetPropertyValue(PROPERTYID propertyId,
                                                     VARIANT* pRetVal) {
    pRetVal->vt = VT_EMPTY;
    UIA_CHECK_ELEMENT(m_pControl);
