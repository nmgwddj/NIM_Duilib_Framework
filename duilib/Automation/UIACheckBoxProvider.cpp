...
//
IFACEMETHODIMP UIACheckBoxProvider::QueryInterface(REFIID riid,
                                                   void** ppInterface) {
    *ppInterface = nullptr;
...
//
IFACEMETHODIMP UIACheckBoxProvider::GetPatternProvider(PATTERNID patternId,
                                                       IUnknown** pRetVal) {
...
IFACEMETHODIMP UIACheckBoxProvider::GetPropertyValue(PROPERTYID propertyId,
                                                     VARIANT* pRetVal) {
    pRetVal->vt = VT_EMPTY;
    UIA_CHECK_ELEMENT(m_pControl);
