...
//
IFACEMETHODIMP UIAScrollBarProvider::QueryInterface(REFIID riid,
                                                    void** ppInterface) {
    *ppInterface = nullptr;
...
//
IFACEMETHODIMP UIAScrollBarProvider::GetPatternProvider(PATTERNID patternId,
                                                        IUnknown** pRetVal) {
...
IFACEMETHODIMP UIAScrollBarProvider::GetPropertyValue(PROPERTYID propertyId,
                                                      VARIANT* pRetVal) {
    pRetVal->vt = VT_EMPTY;
    UIA_CHECK_ELEMENT(m_pControl);
