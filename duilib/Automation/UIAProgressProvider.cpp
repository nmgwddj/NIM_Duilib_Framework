...
//
IFACEMETHODIMP UIAProgressProvider::QueryInterface(REFIID riid,
                                                   void** ppInterface) {
    *ppInterface = nullptr;
...
//
IFACEMETHODIMP UIAProgressProvider::GetPatternProvider(PATTERNID patternId,
                                                       IUnknown** pRetVal) {
...
IFACEMETHODIMP UIAProgressProvider::GetPropertyValue(PROPERTYID propertyId,
                                                     VARIANT* pRetVal) {
    pRetVal->vt = VT_EMPTY;
    UIA_CHECK_ELEMENT(m_pControl);
