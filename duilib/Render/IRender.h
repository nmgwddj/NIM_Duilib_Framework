...
public:
    ...
    AutoClip(IRenderContext* pRender,
...
public:
    ...
    virtual void RestoreAlpha(const UiRect& rcDirty,
                              ...
                              int alpha) = 0;
    virtual void RestoreAlpha(const UiRect& rcDirty,
                              const UiRect& rcShadowPadding) = 0;
};

class UILIB_API IPen : public nbase::SupportWeakCallback {
public:
    IPen(DWORD color, int width = 1)
        : color_(color){};
    IPen(const IPen& r)
        : color_(r.color_){};
...
public:
    ...
    virtual void AddArc(int x,
                        int y,
                        int width,
                        int height,
                        float startAngle,
                        float sweepAngle) = 0;
    virtual void AddPie(int x,
                        int y,
                        int width,
                        int height,
                        float startAngle,
...
public:
    ...
    virtual void RestoreAlpha(const UiRect& rcDirty,
                              ...
                              int alpha) = 0;
    virtual void RestoreAlpha(const UiRect& rcDirty,
                              const UiRect& rcShadowPadding = UiRect()) = 0;
