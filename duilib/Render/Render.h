...
public:
    ...
    virtual void RestoreAlpha(const UiRect& rcDirty,
                              const UiRect& rcShadowPadding,
                              int alpha) override;
    virtual void RestoreAlpha(
        const UiRect& rcDirty,
        const UiRect& rcShadowPadding = UiRect()) override;
    ...
    virtual HRESULT BitBlt(int x,
                           ...
                           int xSrc = 0,
                           int yScr = 0,
                           DWORD rop = SRCCOPY) override;
    virtual bool StretchBlt(int xDest,
                            int yDest,
                            int widthDest,
                            int heightDest,
                            HDC hdcSrc,
                            ...
                            int heightSrc,
                            DWORD rop = SRCCOPY) override;
    virtual bool AlphaBlend(int xDest,
                            int yDest,
                            int widthDest,
                            int heightDest,
                            HDC hdcSrc,
    ...
    virtual void DrawColor(const UiRect& rc,
                           DWORD dwColor,
                           BYTE uFade = 255) override;
    virtual void DrawColor(const UiRect& rc,
    ...
    virtual void DrawLine(const UiRect& rc,
                          int nSize,
                          DWORD dwPenColor) override;
    virtual void DrawLine(const IPen* pen,
                          int x1,
                          int y1,
                          int x2,
                          int y2) override;
    virtual void DrawBezier(const IPen* pen,
                            int x1,
                            int y1,
                            int x2,
                            int y2,
                            ...
                            int x4,
                            int y4) override;
    virtual void DrawRect(const UiRect& rc,
                          int nSize,
                          DWORD dwPenColor) override;
    virtual void DrawRoundRect(const UiRect& rc,
    ...
    void DrawBoxShadow(const UiRect& rc,
                       const CSize& roundSize,
