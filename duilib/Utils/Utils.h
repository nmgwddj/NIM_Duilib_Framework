...
public:
    ...
    bool operator==(const CPoint& dst) { return x == dst.x && y == dst.y; }
...
public:
    ...
    bool IsRectEmpty() const { return ::IsRectEmpty(this) == TRUE; }

    void ResetOffset() { ::OffsetRect(this, -left, -top); }
    ...
    void Offset(int cx, int cy) { ::OffsetRect(this, cx, cy); }

    void Offset(const CPoint& offset) {
        ::OffsetRect(this, offset.x, offset.y);
    }

    void Inflate(int cx, int cy) { ::InflateRect(this, cx, cy); }
    ...
    void Deflate(int cx, int cy) { ::InflateRect(this, -cx, -cy); }
    ...
    void Union(const UiRect& rc) { ::UnionRect(this, this, &rc); }

    void Intersect(const UiRect& rc) { ::IntersectRect(this, this, &rc); }

    void Subtract(const UiRect& rc) { ::SubtractRect(this, this, &rc); }
...
public:
    static std::wstring GetCurrentModuleDir() {
        ...
        ::GetModuleFileNameW(::GetModuleHandle(NULL), &strModulePath[0],
                             (DWORD)strModulePath.length());
