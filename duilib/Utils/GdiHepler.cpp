...
Gdiplus::Bitmap* CreateBitmapFromHBITMAP(HBITMAP hBitmap) {
    ...
    // while a top-down DIB is specified by setting the height to a negative
    // number.
    ...
    LONG cbCopied = GetDIBits(hdcScreen, hBitmap, 0, bmp.bmHeight, piexlsSrc,
    ...
    Gdiplus::Bitmap* pBitmap =
        new Gdiplus::Bitmap(bmp.bmWidth, bmp.bmHeight, PixelFormat32bppPARGB);
