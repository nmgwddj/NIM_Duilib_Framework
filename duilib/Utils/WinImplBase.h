...
#define UI_WNDSTYLE_DIALOG                                    \
    (WS_VISIBLE | WS_POPUPWINDOW | WS_CAPTION | WS_DLGFRAME | \
     WS_CLIPSIBLINGS | WS_CLIPCHILDREN)

#define UI_CLASSSTYLE_FRAME (CS_VREDRAW | CS_HREDRAW)
#define UI_CLASSSTYLE_DIALOG \
...
public:
     ...
     * @return 返回一个自定义控件指针，一般情况下根据 pstrClass
     * 参数创建自定义的控件
     */
     ...
     * @return 返回消息处理结果
     */
    virtual LRESULT OnNcCalcSize(UINT uMsg,
                                 WPARAM wParam,
                                 LPARAM lParam,
                                 BOOL& bHandled);
     ...
     * @return 返回消息处理结果
     */
    virtual LRESULT OnWindowPosChanging(UINT uMsg,
                                        WPARAM wParam,
                                        LPARAM lParam,
                                        BOOL& bHandled);
     ...
     * @return 返回消息处理结果
     */
    virtual LRESULT OnChar(UINT uMsg,
                           WPARAM wParam,
                           LPARAM lParam,
                           BOOL& bHandled);
