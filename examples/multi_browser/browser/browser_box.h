...
private:
    void OnBeforeMenu(CefRefPtr<CefContextMenuParams> params,
                      CefRefPtr<CefMenuModel> model);
    bool OnMenuCommand(CefRefPtr<CefContextMenuParams> params,
                       int command_id,
    ...
    CefRequestHandler::ReturnValue OnBeforeNavigate(
    ...
    void OnLoadError(CefLoadHandler::ErrorCode errorCode,
