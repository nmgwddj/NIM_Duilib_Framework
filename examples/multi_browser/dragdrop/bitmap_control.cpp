...
void BitmapControl::Paint(ui::IRenderContext* pRender,
                          const ui::UiRect& rcPaint) {
    ...
    pRender->AlphaBlend(
        m_rcItem.left, m_rcItem.top, m_rcItem.right - m_rcItem.left,
        m_rcItem.bottom - m_rcItem.top, hCloneDC, 0, 0,
