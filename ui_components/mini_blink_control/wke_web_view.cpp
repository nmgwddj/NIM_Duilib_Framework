...
void OnPaintCallback(wkeWebView webView,
                     void* param,
                     const void* buffer,
                     const wkeRect* r,
                     int width,
...
void WkeWebView::Paint(ui::IRenderContext* pRender, const ui::UiRect& rcPaint) {
    ...
    BitBlt(pRender->GetDC(), m_rcItem.left, m_rcItem.top, m_rcItem.GetWidth(),
           m_rcItem.GetHeight(), m_web_view_dc->GetDC(), 0, 0, SRCCOPY);
}
...
LRESULT WkeWebView::MessageHandler(UINT uMsg,
                                   WPARAM wParam,
                                   LPARAM lParam,
                                   BOOL& bHandled) {
    ...
    switch (uMsg) {
        ...
        case WM_KEYDOWN: {
            ...
            bHandled = wkeFireKeyDownEvent(m_wke_web_view, virtualKeyCode,
                                           flags, false);
        } break;
        ...
        case WM_KEYUP: {
            ...
            bHandled =
                wkeFireKeyUpEvent(m_wke_web_view, virtualKeyCode, flags, false);
        } break;
        ...
        case WM_CHAR: {
            ...
            bHandled =
                wkeFireKeyPressEvent(m_wke_web_view, charCode, flags, false);
        } break;
        ...
        case WM_MOUSEMOVE: {
            ...
            bHandled = wkeFireMouseEvent(m_wke_web_view, uMsg, pWebPt.x,
                                         pWebPt.y, flags);
        ...
        case WM_CONTEXTMENU: {
            ...
            bHandled =
                wkeFireContextMenuEvent(m_wke_web_view, pt.x, pt.y, flags);
        } break;
        ...
        case WM_MOUSEWHEEL: {
            ...
            bHandled = wkeFireMouseWheelEvent(m_wke_web_view, pt.x, pt.y, delta,
                                              flags);
        } break;
...
void WkeWebView::OnPaint(wkeWebView webView,
                         const void* buffer,
                         const wkeRect* r,
                         int width,
                         int height) {
    ...
    if (m_web_view_dc->GetWidth() != width ||
        m_web_view_dc->GetHeight() != height)
