...
class BrowserHandler : public nbase::SupportWeakCallback,
                       public CefClient,
...
public:
     ...
     * @brief
     *BrowserHandler的消息委托类接口，BrowserHandler类会处理多数Cef浏览器对象的事件
    ...
    public:
        ...
        virtual bool OnExecuteCppCallbackFunc(int cpp_callback_id,
                                              const CefString& json_string) = 0;
    };
