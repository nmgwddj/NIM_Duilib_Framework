...
public:
    ...
    virtual void SetWindow(ui::Window* pManager,
                           ui::Box* pParent,
                           bool bInit) override;
    ...
    virtual LRESULT MessageHandler(
        ...
        WPARAM wParam,
        LPARAM lParam,
        BOOL& bHandled) override;  // 处理窗体消息，转发到Cef浏览器对象
...
protected:
     ...
     * @return 返回消息处理结果
     */
    LRESULT SendButtonDownEvent(UINT uMsg,
                                WPARAM wParam,
                                LPARAM lParam,
                                BOOL& bHandled);
     ...
     * @return 返回消息处理结果
     */
    LRESULT SendButtonDoubleDownEvent(UINT uMsg,
                                      WPARAM wParam,
                                      LPARAM lParam,
                                      BOOL& bHandled);
     ...
     * @return 返回消息处理结果
     */
    LRESULT SendButtonUpEvent(UINT uMsg,
                              WPARAM wParam,
                              LPARAM lParam,
                              BOOL& bHandled);
     ...
     * @return 返回消息处理结果
     */
    LRESULT SendMouseMoveEvent(UINT uMsg,
                               WPARAM wParam,
                               LPARAM lParam,
                               BOOL& bHandled);
     ...
     * @return 返回消息处理结果
     */
    LRESULT SendMouseWheelEvent(UINT uMsg,
                                WPARAM wParam,
                                LPARAM lParam,
                                BOOL& bHandled);
     ...
     * @return 返回消息处理结果
     */
    LRESULT SendMouseLeaveEvent(UINT uMsg,
                                WPARAM wParam,
                                LPARAM lParam,
                                BOOL& bHandled);
     ...
     * @return 返回消息处理结果
     */
    LRESULT SendKeyEvent(UINT uMsg,
                         WPARAM wParam,
                         LPARAM lParam,
                         BOOL& bHandled);
     ...
     * @return 返回消息处理结果
     */
    LRESULT SendCaptureLostEvent(UINT uMsg,
                                 WPARAM wParam,
                                 LPARAM lParam,
                                 BOOL& bHandled);
