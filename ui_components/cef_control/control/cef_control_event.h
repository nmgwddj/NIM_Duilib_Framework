...
namespace ui {
typedef std::function<void(CefRefPtr<CefContextMenuParams> params,
                           CefRefPtr<CefMenuModel> model)>
    OnBeforeMenuEvent;
typedef std::function<bool(CefRefPtr<CefContextMenuParams> params,
                           int command_id,
...
typedef std::function<CefRequestHandler::ReturnValue(
    CefRefPtr<CefRequest> request,
    bool is_redirect)>
    OnBeforeResourceLoadEvent;
typedef std::function<void(const CefString& old_url, const CefString& new_url)>
    OnMainURLChengeEvent;

typedef std::function<void(bool isLoading, bool canGoBack, bool canGoForward)>
...
typedef std::function<void(CefLoadHandler::ErrorCode errorCode,
...
typedef std::function<bool(CefDialogHandler::FileDialogMode mode,
