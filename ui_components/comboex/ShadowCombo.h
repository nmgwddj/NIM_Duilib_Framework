...
public:
    ...
    void SetAttribute(const std::wstring& strName,
     ...
     */
    void SetShadowImage(const std::wstring& ShadowImage) {
        m_sShadowImage = ShadowImage;
    }
    ...
    void AttachSelect(const EventCallback& callback) {
        OnEvent[kEventSelect] +=
            callback; /*m_pLayout->AttachSelect(callback);*/
    }                 // mod by djj
